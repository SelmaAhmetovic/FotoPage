...
<?php
	...
	$dbh1= new PDO("mysql:dbname=spirala4;host=localhost;charset=utf8", "admin", "admin123");
...
<div id="meni">
	...
	<p><a href="changePassword.php" style="background-color:white">Promjeni password</a</p>
	<p><a href="deleteUser.php" style="background-color:white">Obriši korisnika</a></p>
	<p><a href="dodajUBazu.php" style="background-color:white">Stavi podatke iz XML-a u bazu</a></p>
	<p><a href="logout.php" style="background-color:white">Logout</a></p>
	</div>
  </body>
</html>